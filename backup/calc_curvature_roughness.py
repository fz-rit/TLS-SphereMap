...
def visualize_results(all_points: np.ndarray, all_curvatures: np.ndarray, all_roughness: np.ndarray) -> None:
...
def calculate_curvature_and_roughness(config: Dict[str, Any]) -> None:
    ...
    if export:    
        export_results(df_filtered_out, normalized_curvatures, normalized_roughness, output_dir, filename)
